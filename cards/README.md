...
```
cd existing_repo
git remote add origin http://ec2-16-170-195-53.eu-north-1.compute.amazonaws.com/codexioltd/engineering-survivor/06.2023/recard/cards.git
git branch -M main
...
- [ ] [Set up project integrations](http://ec2-16-170-195-53.eu-north-1.compute.amazonaws.com/codexioltd/engineering-survivor/06.2023/recard/cards/-/settings/integrations)
